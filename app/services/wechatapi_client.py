...
class WechatApiClient:
    ...
    def _post(self, path: str, payload: dict[str, Any]) -> Dict[str, Any]:
        ...
        if self._session is not None:
            ...
            resp = requests.post(url, json=payload, headers=self._headers(), timeout=15, proxies={"http": None, "https": None})
    ...
    def fetch_contacts_list(self) -> Dict[str, Any]:
        ...
        """
        return self._post("/contacts/fetchContactsList", {"appId": self.app_id})

    def fetch_contacts_list_cache(self) -> Dict[str, Any]:
        """Get cached contacts list (10-min cache)."""
        return self._post("/contacts/fetchContactsListCache", {"appId": self.app_id})
